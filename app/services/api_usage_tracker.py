"""
API Usage Tracker for monitoring and optimizing Groq API usage
"""
...
class APIUsageTracker:
    def __init__(self):
        ...
        # Groq free tier: ~14,400 RPD (requests per day) for most models;
        # setting a conservative cap to stay safe.
    ...
    def get_usage_stats(self) -> Dict:
        ...
        avg_response_time = (
            sum(log["response_time"] for log in today_calls) / len(today_calls)
    ...
    def suggest_optimization(self) -> List[str]:
        ...
        if self.daily_usage > self.max_daily_requests * 0.8:
            suggestions.append("Approaching daily limit. Consider upgrading to a paid Groq plan for higher limits.")
